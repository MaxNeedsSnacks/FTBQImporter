...
@Mod(modid = FTBQImporter.MOD_ID, name = FTBQImporter.MOD_NAME,
     version = FTBQImporter.VERSION, acceptableRemoteVersions = "*",
     dependencies =
         "required-after:ftblib@[0.0.0ftblib,);required-after:ftbquests",
...
public class FTBQImporter {
  ...
  public static final Logger LOGGER =
      LogManager.getLogger("FTB Quests Importer");
